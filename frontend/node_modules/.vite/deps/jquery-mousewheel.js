...
var require_jquery_mousewheel = __commonJS({
  "node_modules/jquery-mousewheel/jquery.mousewheel.js"(exports, module) {
    (function(factory) {
      ...
      "use strict";
      var nullLowestDeltaTimeout, lowestDelta, modernEvents = !!$.fn.on, toFix = ["wheel", "mousewheel", "DOMMouseScroll", "MozMousePixelScroll"], toBind = "onwheel" in window.document || window.document.documentMode >= 9 ? ["wheel"] : ["mousewheel", "DomMouseScroll", "MozMousePixelScroll"], slice = Array.prototype.slice;
      if ($.event.fixHooks) {
...
export default require_jquery_mousewheel();
